			...
			<?php while ( have_posts() ) : the_post(); $metadata = wp_get_attachment_metadata(); ?>
				<article <?php post_class(); ?>>
					...
					<div class="entry-content entry-attachment">
						...
						<p><strong><?php _e( 'URL:', 'haste-store' ); ?></strong> <a href="<?php echo esc_url( wp_get_attachment_url() ); ?>" title="<?php the_title_attribute(); ?>" rel="attachment"><span><?php echo esc_attr( basename( wp_get_attachment_url() ) ); ?></span></a></p>
