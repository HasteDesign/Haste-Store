...
add_action( 'tgmpa_register', 'haste_store_register_required_plugins' );

/**
 * This function is hooked into `tgmpa_register`, which is fired on the WP `init` action on priority 10.
 */
function haste_store_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'haste-store',                  // Unique ID for hashing notices for multiple instances of TGMPA.
